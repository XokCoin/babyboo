// BABYBOO HODL BABYBOO EARN FREE bool
// MADE BY JOSIAH, KING OF BABYS
...
contract BABYBOO is ERC20, Ownable {
    ...
    address public immutable CAKE = address(0x841FAD6EAe12c286d1Fd18d1d525DFfA75C7EFFE); //CAKE
    ...
    address public _marketingWalletAddress = 0x52Dd24b1ee7FD49b325C7a08287C0f6802410313;
    ...
    constructor() public ERC20("BABYBOO", "BABYBOO") {
...
contract BABYCAKEDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() public DividendPayingToken("BABYBOO_Dividen_Tracker", "BABYBOO_Dividend_Tracker") {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 200000 * (10**18); //must hold 200000+ tokens
    }

    function _transfer(address, address, uint256) internal override {
        require(false, "BABYBOO_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "BABYBOO_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BABYCAKE contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "BABYBOO_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "BABYBOO_Dividend_Tracker: Cannot update claimWait to same value");
